package com.romanuel.run.presentation.active_run.service
...
import com.romanuel.core.presentation.designsystem.R.drawable.logo
import com.romanuel.core.presentation.ui.formatted
import com.romanuel.run.domain.RunningTracker
import com.romanuel.run.presentation.R.string.active_run
    ...
    private fun start(activityClass: Class<*>) {
        if (!isServiceActive) {
            ...
            val activityIntent = Intent(applicationContext, activityClass).apply {
                data = APP_PACKAGE_DEEP_LINK.toUri()
